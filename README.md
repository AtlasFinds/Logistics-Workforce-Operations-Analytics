...
### **Task**
As the Senior HRIS Analytics Specialist, I was tasked with creating a robust analytics package and dashboard mockup to identify early turnover indicators, isolate high-risk cohorts, analyze safety compliance correlations, and present findings in an interactive, executive-ready dashboard to drive operational policy changes.
